...
namespace CompleatWebTest
{

    public class LoginAsGarethTenantOne : BaseWebAiiTest
    {
        ...
        public void LoginAsGarethTenantOne_CodedStep()
        {
            ActiveBrowser.ContentWindow.SetFocus();
            Pages.Login.PasswordPassword.ScrollToVisible();
            Pages.Login.PasswordPassword.Focus();
